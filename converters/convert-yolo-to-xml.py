...
folder_holding_yolo_files = input("Enter the path to the yolo files (folder): ").replace("'", "").strip()
yolo_class_list_file = input("Enter the path to the file that has the yolo classes (typically classes.txt) \nOpen your YOLO file, if started with 15 such as 15 0.063802 0.299537 0.003646 0.013889 \nIt means that it will takes value of 16th line in your classes.txt file \nMake sure that your classes.txt file have all labels which you have used: ").strip()
